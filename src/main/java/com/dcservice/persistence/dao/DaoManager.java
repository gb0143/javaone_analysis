...
public class DaoManager {
  ...
  public static Session getSession() throws Exception {
    if (FacesContext.getCurrentInstance() == null) {
      throw new Exception("DaoManager: 44; \"FacesContext.getCurrentInstance() is null\"");
    }
  ...
  public static <T extends BaseModel> void remove(T object, boolean beginTransaction) {
    Transaction tr = null;
    try {
      if (beginTransaction) {
	tr = DaoManager.getSession().beginTransaction();
