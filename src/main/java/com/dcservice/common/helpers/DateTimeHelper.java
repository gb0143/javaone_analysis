...
public class DateTimeHelper extends BaseBaseClass
{
    ...
    private static DateFormat posgresFormatter                = new SimpleDateFormat(
                                                                      postgresTimePattern);
    
    private static DateFormat mySqlFormatter                  = new SimpleDateFormat(
                                                                      mySQLDateTimePattern);
    ...
    public static String toFormatedString(Date value, String format,
            Locale local, TimeZone timeZone)
    {
    ...
    public static void setDatePatternSlashWithTimezone(
            String datePatternSlashWithTimezone)
    {
    ...
    public static void setDatePatternDotsWithTimezone(
            String datePatternDotsWithTimezone)
    {
    ...
    public static void setPathDateTimeWithSecondsPattern(
            String pathDateTimeWithSecondsPattern)
    {
    ...
    public static class ComboboxHelper extends BaseBaseClass
    {
        ...
        public static <T extends BaseModel> List<SelectItem> listToCombobox(
                List<T> list, boolean showNotSelected)
        {
        ...
        public static <T> List<SelectItem> fillList(Class<T> clazz,
                boolean showNotSelected) throws Exception
        {
...
*/            
        ...
        public static <T extends BaseModel> List<SelectItem> fillList(Class<T> clazz,
                ...
                PersistenceBeanException, IllegalAccessException
        {
            return fillList(clazz, order, new ArrayList<Criterion>(),
                    addNotSelected);
        }
        
        public static <T extends BaseModel> List<SelectItem> fillList(Class<T> clazz,
                Order order, List<Criterion> criterions, boolean addNotSelected)
                throws HibernateException, PersistenceBeanException,
                IllegalAccessException
        {
        ...
        public static <T extends BaseModel> List<SelectItem> fillList(Class<T> clazz,
                Order order, List<Criterion> criterions,
                List<String> criteriaAlias, boolean addNotSelected)
                throws HibernateException, PersistenceBeanException,
                IllegalAccessException
        {
            List<SelectItem> list = new ArrayList<SelectItem>();
                ...
                boolean showNotSelected, boolean showAllElement)
        {
            ...
            if (array.length > 0)
            {
                ...
                for (Object item : array)
                {
                    ...
                    try
                    {
                        list.add(new SelectItem(getIdMethod == null ? isEnum ? item
                                .getClass().getMethod("name").invoke(item) : item
                                .toString() : getIdMethod.invoke(item), item
                                .toString()));
                    }
                    catch(Exception e)
                    {
        ...
        public static class SelectItemHelper
        {
            public static SelectItem getNotSelected()
            {
                return new SelectItem("", "- "
                        + ResourcesHelper.getString("notSelected") + " -");
            }
